...
class Command(BaseCommand):
    help = "Seed the Crypto SchemaTemplate and its default columns."

    def handle(self, *args, **kwargs):
        cfg = CRYPTO_TEMPLATE_CONFIG
        ...
        # Loop through columns based on CONFIG
        ...
        self.stdout.write(self.style.SUCCESS(
            "✅ Crypto Schema Template seeded successfully."
        ))
