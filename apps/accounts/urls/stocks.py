...
urlpatterns = [
    ...
    path('self-managed/<int:pk>/', SelfManagedAccountDetailView.as_view(), name='self-managed-detail'),
    path('managed/', ManagedAccountListCreateView.as_view(), name='managed-accounts'),
    path('managed/<int:pk>/', ManagedAccountDetailView.as_view(), name='managed-detail'),
