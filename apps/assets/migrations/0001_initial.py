    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('domain', models.CharField(choices=[('equity', 'Equities'), ('crypto', 'Crypto'), ('metal', 'Metals'), ('bond', 'Bonds'), ('real_estate', 'Real Estate'), ('managed', 'Managed Accounts'), ('custom', 'Custom')], max_length=20)),
