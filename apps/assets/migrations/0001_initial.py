    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_type', models.CharField(choices=[('stock', 'Stock'), ('crypto', 'Crypto'), ('metal', 'Metal'), ('custom', 'Custom')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.DecimalField(decimal_places=12, default=0, max_digits=30)),
                ('purchase_price', models.DecimalField(blank=True, decimal_places=12, help_text='Price per unit in account currency at purchase time', max_digits=30, null=True)),
