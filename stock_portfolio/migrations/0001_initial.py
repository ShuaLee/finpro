    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active_schema', models.ForeignKey(blank=True, help_text='Schema used to display stock holdings for this account.', null=True, on_delete=django.db.models.deletion.CASCADE, to='stock_portfolio.schema')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stock_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='stockholdings', to='stock_portfolio.selfmanagedaccount')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('default_managed_schema', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='default_for_managed_accounts', to='stock_portfolio.schema')),
                ('default_self_managed_schema', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='default_for_self_managed_accounts', to='stock_portfolio.schema')),
